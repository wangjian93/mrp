...
public interface DemandLcmRepository extends JpaRepository<DemandLcm, DemandKey> {
    ...
    List<Map> getDemandQtyLcm(@Param("ver") String ver, @Param("material") String material);
    ...
    Double getDemandQtyLcm(@Param("ver") String ver, @Param("material") String material, @Param("fabDate") Date fabDate);
